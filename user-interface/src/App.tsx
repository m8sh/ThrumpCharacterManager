...
const statblocks: Record<string, Statblock> = {
    "Vampire Fledgling": {
        ...
        tags: "Humanoid, Vampire, Undead, Any Race; Minor; Black Soul (1500)",
        stats: [
            {group: "Characteristics", rows: [["Strength", "40"], ["Endurance", "50"], ["Agility", "50"], ["Intelligence", "35"], ["Willpower", "40"], ["Perception", "50"], ["Personality", "30"], ["Morale", "50"]]},
            {group: "Attributes", rows: [["Hit Points", "25"], ["Wound Thr.", "13"], ["Magicka", "35"], ["Stamina", "5"], ["Initiative", "+13"], ["Action Pts.", "3"], ["Speed", "14m"], ["Size", "Std."]]},
            {group: "Skills", rows: [["Combat", "60"], ["Magic", "40"], ["Evade", "50"], ["Observe", "60"], ["Stealth", "60"], ["Knowledge", "40"], ["Social", "40"], ["Physical", "50"]]},
        ],
        sections: [
            {head: "Vampires", kind: "prose", items: [
                    {text: "Forced to forever thirst for the blood of mortals, Vampires foul creatures born of the hateful magics of the Prince of Domination, Molag Bal. Some are no more than ravenous beasts stalking the countryside and back alleys for their next victim, while others are well hidden within the nobility of Tamriel and lead luxurious lives. Their affliction is seen as a curse by most, but some recognize it as a pathway to incredible, and terrible, power."},
                ]},
            {head: "Weapons and Armor", kind: "list", items: [
                    {name: "Claws", text: "1d4; Slashing, Magic; 1m Reach"},
                    {name: "Fangs", text: "1d6; Splitting, Magic, Feed; 1m Reach"},
                    {text: "Has one of:"},
                    ...
                    {text: "Also has:"},
                    {name: "Full Leather Armor", text: "AR 3 / 1 Fire; Medium"},
                    {name: "Cloth Cloak", text: "Used to conceal themselves from natural daylight."},
                ]},
            {head: "Special Abilities", kind: "list", items: [
                    {name: "Feed (1 AP)", text: "The vampire feeds on a restrained, helpless, or enthralled target as a standard attack with their fangs, regaining HP equal to the damage dealt after mitigation. If a point of damage is dealt successfully, the target\u2019s Endurance characteristic is reduced by 10 until after their next long rest. The vampire can choose to use this ability to Coup de Gr\u00e2ce the target as long as the conditions are met, in which case they regain the target\u2019s remaining HP. Doing so costs 2 AP and the vampire cannot take actions until their AP is refreshed."},
                    {name: "Exsanguinate (2 AP)", text: "The vampire can use their fangs to Coup de Gr\u00e2ce the target as long as the conditions are met, in which case they regain the target\u2019s remaining HP. After doing so, the vampire loses any remaining AP for the round."},
                ]},
            {head: "Traits", kind: "list", items: [
                    {name: "Sun-Scarred (2)", text: "Any damage inflicted on a character with this trait after mitigation by an attack that counts as sunlight is increased by 2 before calculating the effects of the damage. If this character is exposed to normal sunlight they lose 1 SP each hour. Cloud cover or other such weather halves the rate of SP loss. The character must spend an hour in a dark place before they can remove levels of fatigue/regain SP lost in this manner."},
                    {name: "Dawn-Cursed (1)", text: "While in direct sunlight, the character suffers 1 damage per round which ignores all damage mitigation. If the character covers themselves completely with clothing and a hood with sufficient coverage, this damage is reduced to 1 per hour in the sunlight."},
                    {name: "Dark Sight"},
                    {name: "Weakness (Fire, 2)"},
                    {name: "Resist Normal Weapons (2)"},
                    {name: "Undead"},
                    {name: "Diseased (-20, Vampiric Strain)"},
                ]},
            {head: "Spells", kind: "list", items: [
                    {name: "Frost Bite 3", text: "7 MP; 1d8 Frost; Attack, Overload (+WpB to Damage), Melee (1m)"},
                ]},
            {head: "Variant: Bloodkin Vampire Fledgling", kind: "list", items: [
                    {text: "Choose a Bloodline from the Rules Compendium. Bloodkin Vampire Fledglings gain a passive ability from the chosen bloodline."},
                ]},
            {head: "Encountering Vampire Fledglings", kind: "prose", items: [
                    {text: "Often panicked or near-feral, Vampire Fledglings are mortals unfortunate, or fortunate, enough to have recently succumbed to a vampiric disease. Many are created unintentionally by more powerful vampires in the rare instances that their prey survives and, in these cases, they are often maddened or panicked. Fledglings lack the grace and tact that their more experienced kin possess and are more likely to savagely quench their thirst for blood. They also lack a full grasp of their newfound powers and are unable to call upon the more powerful abilities that vampirism grants them."},
                    {text: "Vampire Fledglings are often the servants of more powerful vampires, serving a GM as a step-up in difficulty from the vampire thrall they may also be in control of. In this context, they may be desperate to prove themselves to their master and reckless in their attacks against adventurers. Other Fledglings may stalk the streets of the town or city they call home at night, looking for their next victim. The savaged corpses of the slain are all they leave behind to be found when the sun rises, offering an inquisitive party a potential mystery to solve."},
                ]},
            {head: "Loot", kind: "list", items: [
                    {text: "A Character can make a +0 Alchemy test to harvest a portion of \u201cVampire Fledgling Dust\u201d, which is a Rare Illusion or Restoration Ingredient, chosen when the vampire dust is used."},
                ]},
        ],
    },
    "Vampire": {
        name: "Vampire",
        flavour: "Possessed of an insatiable thirst for blood, these cursed undead often use guile, trickery, and foul magicks to sustain themselves.",
        tags: "Humanoid, Vampire, Undead, Any Race; Average; Black Soul (1500)",
        stats: [
            {group: "Characteristics", rows: [["Strength", "40"], ["Endurance", "60"], ["Agility", "50"], ["Intelligence", "40"], ["Willpower", "50"], ["Perception", "50"], ["Personality", "30"], ["Morale", "65"]]},
            {group: "Attributes", rows: [["Hit Points", "32"], ["Wound Thr.", "16"], ["Magicka", "40"], ["Stamina", "6"], ["Initiative", "+14"], ["Action Pts.", "3"], ["Speed", "14m"], ["Size", "Std."]]},
            {group: "Skills", rows: [["Combat", "80"], ["Magic", "70"], ["Evade", "60"], ["Observe", "70"], ["Stealth", "80"], ["Knowledge", "60"], ["Social", "50"], ["Physical", "60"]]},
        ],
        sections: [
            {head: "Vampires", kind: "prose", items: [
                    {text: "Forced to forever thirst for the blood of mortals, Vampires foul creatures born of the hateful magics of the Prince of Domination, Molag Bal. Some are no more than ravenous beasts stalking the countryside and back alleys for their next victim, while others are well hidden within the nobility of Tamriel and lead luxurious lives. Their affliction is seen as a curse by most, but some recognize it as a pathway to incredible, and terrible, power."},
            ...
            {head: "Weapons and Armor", kind: "list", items: [
                    {name: "Claws", text: "1d4; Slashing, Magic; 1m Reach"},
                    {name: "Fangs", text: "1d8; Splitting, Magic, Feed; 1m Reach"},
                    {text: "Has one of:"},
                    {name: "Steel Longsword", text: "1d8(1d10)+1; Slashing; Reach 2m, 1.5H"},
                    {name: "Steel Battle Axe", text: "1d8(1d10)+1; Splitting, Unwieldy; Reach 2m, 1.5H"},
                    {name: "Steel Warhammer", text: "1d8(1d10)+1; Crushing, Unwieldy; Reach 2m, 1.5H"},
                    {text: "Also has:"},
                    {name: "Partial Vampiric Armor", text: "AR 5 / 1 Magic; Medium, Magic"},
                    {name: "Cloth Cloak", text: "Used to conceal themselves from natural daylight."},
                ]},
            {head: "Special Abilities", kind: "list", items: [
                    {name: "Feed (1 AP)", text: "The vampire feeds on a restrained, helpless, or enthralled target as a standard attack with their fangs, regaining HP equal to the damage dealt after mitigation. If a point of damage is dealt successfully, the target\u2019s Endurance characteristic is reduced by 10 until after their next long rest. The vampire can choose to use this ability to Coup de Gr\u00e2ce the target as long as the conditions are met, in which case they regain the target\u2019s remaining HP. Doing so costs 2 AP and the vampire cannot take actions until their AP is refreshed."},
                    {name: "Exsanguinate (2 AP)", text: "The vampire can use their fangs to Coup de Gr\u00e2ce the target as long as the conditions are met, in which case they regain the target\u2019s remaining HP. After doing so, the vampire loses any remaining AP for the round."},
                    {name: "Vampiric Drain (1 AP + 11 MP)", text: "As a primary action, the vampire attacks, dealing 2d6 magic damage to a target within 4m, restoring their own HP by the amount of damage successfully dealt (after any reduction). If this spell is affected by a reflect spell or effect, it has no net effect."},
                    {name: "Bat Form (1 AP + 1 SP)", text: "As a Secondary Action, the Vampire gains the Flyer (10) trait, changes their size to Tiny (-20 to hit by larger characters or at range), and reduces their max HP to 5. This effect ends after 3 rounds unless the character spends 1 SP, which refreshes the effect for another 3 rounds. This ability ends immediately and the Vampire reverts to their true form if the HP is reduced to 0."},
                ]},
            {head: "Traits", kind: "list", items: [
                    {name: "Sun-Scarred (3)", text: "Any damage inflicted on a character with this trait after mitigation by an attack that counts as sunlight is increased by 3 before calculating the effects of the damage. If this character is exposed to normal sunlight they lose 1 SP each hour. Cloud cover or other such weather halves the rate of SP loss. The character must spend an hour in a dark place before they can remove levels of fatigue/regain SP lost in this manner."},
                    {name: "Dawn-Cursed (2)", text: "While in direct sunlight, the character suffers 2 damage per round which ignores all damage mitigation. If the character covers themselves completely with clothing and a hood with sufficient coverage, this damage is reduced to 2 per hour in the sunlight."},
                    {name: "Dark Sight"},
                    {name: "Weakness (Fire, 2)"},
                    {name: "Resist Normal Weapons (3)"},
                    {name: "Undead"},
                    {name: "Diseased (-20, Vampiric Strain)"},
                ]},
            {head: "Spells", kind: "list", items: [
                    {name: "Frost Bite 5", text: "11 MP; 2d6 Frost; Attack, Overload (+WpB to Damage), Melee (1m)"},
                    {name: "Frost Bolt 3", text: "8 MP; 1d8 Frost; Ranged (100m), Overload (+WB to Damage), Attack"},
                    {name: "Paralyze 2", text: "18 MP; Upkeep, Direct, Attack; Target character within 50m must test Wp at +10 or be Paralyzed for 1 round."},
                    {name: "Silence 4", text: "16 MP; Upkeep, Direct, Attack; Target character within 50m must test Wp at -10 or be Silenced for 1 round."},
                ]},
            {head: "Variant: Bloodkin Vampire", kind: "list", items: [
                    {text: "Choose a Bloodline from the Rules Compendium. Bloodkin Vampires gain a passive ability from the chosen bloodline. Additionally, they gain the corresponding bloodline power and talent from the Child of the Night Elite advance."},
                ]},
            {head: "Encountering Vampires", kind: "prose", items: [
                    {text: "More experienced in the foul gifts of their curse, Vampires have learned to control their powers and use them to further their own goals. Many Vampires live on the fringes of society, living as outcasts amongst their own kind and preying upon any unfortunate mortal who they come across. Others integrate themselves into Tamrielic society, living relatively normal lives and feeding in secret. Many Vampires will seek power and dominion over others, perhaps influenced by Molag Bal\u2019s curse, and will have a retinue of weak-willed thrall in their service."},
                    {text: "While not at the apex of their power, Vampires can still prove to be a dangerous threat to low-level parties who are unprepared to face them. They are often smart and selfish, but typically find themselves living in covens of their own kind in service to a stronger, more powerful vampire. Others may be upstanding members of society with a dark secret. In combat, Vampires are often \u201cspell swords,\u201d using both martial combat and blood-magic to dispatch their foes."},
                    {text: "GMs running campaigns involving Vampires should take the time to consider the context in which their party will face them; will the party face a cave full of these bloodthirsty undead outright, or will they instead be investigating mysterious disappearances and blood-drained bodies with no obvious culprit in sight? GMs should not be afraid to get creative to make their Vampires unique and to craft encounters appropriate for their party or game-style."},
                ]},
            {head: "Loot", kind: "list", items: [
                    {text: "A Character can make a +0 Alchemy test to harvest a portion of \u201cVampire Dust\u201d, which is a Very Rare Illusion or Restoration Ingredient, chosen when the vampire dust is used."},
                ]},
        ],
    },
    "Master Vampire": {
        name: "Master Vampire",
        flavour: "Experienced, charismatic, and deadly, these bloodthirsty undead will stop at nothing to maintain and increase their dark power.",
        tags: "Humanoid, Vampire, Undead, Any Race; Major; Black Soul (1500)",
        stats: [
            {group: "Characteristics", rows: [["Strength", "50"], ["Endurance", "65"], ["Agility", "60"], ["Intelligence", "50"], ["Willpower", "70"], ["Perception", "60"], ["Personality", "45"], ["Morale", "75"]]},
            {group: "Attributes", rows: [["Hit Points", "34"], ["Wound Thr.", "18"], ["Magicka", "50"], ["Stamina", "6"], ["Initiative", "+19"], ["Action Pts.", "3"], ["Speed", "19m"], ["Size", "Std."]]},
            {group: "Skills", rows: [["Combat", "100"], ["Magic", "90"], ["Evade", "80"], ["Observe", "80"], ["Stealth", "90"], ["Knowledge", "70"], ["Social", "65"], ["Physical", "70"]]},
        ],
        sections: [
            {head: "Vampires", kind: "prose", items: [
                    {text: "Forced to forever thirst for the blood of mortals, Vampires foul creatures born of the hateful magics of the Prince of Domination, Molag Bal. Some are no more than ravenous beasts stalking the countryside and back alleys for their next victim, while others are well hidden within the nobility of Tamriel and lead luxurious lives. Their affliction is seen as a curse by most, but some recognize it as a pathway to incredible, and terrible, power."},
            ...
            {head: "Weapons and Armor", kind: "list", items: [
                    ...
                    {name: "Fangs", text: "1d8; Splitting, Magic, Feed; 1m Reach"},
                    {text: "Has one of:"},
                    {name: "Malachite Longsword", text: "1d8(1d10)+3; Slashing, Magic; Reach 2m, 1.5H"},
                    {name: "Malachite Battle Axe", text: "1d8(1d10)+3; Splitting, Magic, Unwieldy; Reach 2m, 1.5H"},
                    {name: "Malachite Warhammer", text: "1d8(1d10)+3; Crushing, Unwieldy, Magic; Reach 2m, 1.5H"},
                    {text: "Also has:"},
                    {name: "Full Vampiric Armor", text: "AR 7 / 3 Magic; Light, Magic"},
                    {name: "Silk Cloak", text: "Used to conceal themselves from natural daylight."},
                ]},
            {head: "Special Abilities", kind: "list", items: [
                    {name: "Feed (1 AP)", text: "The vampire feeds on a restrained, helpless, or enthralled target as a standard attack with their fangs, regaining HP equal to the damage dealt after mitigation. If a point of damage is dealt successfully, the target\u2019s Endurance characteristic is reduced by 10 until after their next long rest. The vampire can choose to use this ability to Coup de Gr\u00e2ce the target as long as the conditions are met, in which case they regain the target\u2019s remaining HP. Doing so costs 2 AP and the vampire cannot take actions until their AP is refreshed."},
                    {name: "Exsanguinate (2 AP)", text: "The vampire can use their fangs to Coup de Gr\u00e2ce the target as long as the conditions are met, in which case they regain the target\u2019s remaining HP. After doing so, the vampire loses any remaining AP for the round."},
                    {name: "Vampiric Drain (1 AP + 11 MP)", text: "The vampire drains 2d6 magic damage to a target within 4m, restoring their own HP by the amount of damage successfully dealt (after any reduction). If this spell is affected by a reflect spell or effect, it has no net effect."},
                    {name: "Blood Grasp (1 AP + 10 MP)", text: "The vampire forces a target within a 15m range to make a -10 Str test. On a failure, the vampire can force the target to move up to 10m closer to them. This forced movement can trigger Attacks of Opportunity."},
                    {name: "Shrouding Mist (1 AP + 1 SP)", text: "The vampire calls upon the eternal darkness to cause the surrounding area in a 2 kilometer radius to be consumed by a heavy fog. This imposes a -10 penalty to all Observe tests and any vampire within the area has their Dawn-Cursed trait value reduced by 1 for as long as the fog remains. The fog lasts for 5 hours and cannot be ended early unless affected by a more powerful magic. This ability takes five minutes to cast."},
                    {name: "Bat Form (1 AP + 1 SP)", text: "They gain the Flyer (10) trait, change their size to Tiny (-20 to hit by larger characters or at range), and reduce their max HP to 5. The effect ends after 3 rounds unless the character spends 1 SP, which refreshes the effect for another 3 rounds. The ability ends immediately and the vampire reverts to their true form if the HP is reduced to 0."},
                ]},
            {head: "Traits", kind: "list", items: [
                    {name: "Sun-Scarred (3)", text: "Any damage inflicted on a character with this trait after mitigation by an attack that counts as sunlight is increased by 3 before calculating the effects of the damage. If this character is exposed to normal sunlight they lose 1 SP each hour. Cloud cover or other such weather halves the rate of SP loss. The character must spend an hour in a dark place before they can remove levels of fatigue/regain SP lost in this manner."},
                    {name: "Dawn-Cursed (3)", text: "While in direct sunlight, the character suffers 3 damage per round which ignores all damage mitigation. If the character covers themselves completely with clothing and a hood with sufficient coverage, this damage is reduced to 3 per hour in the sunlight."},
                    {name: "Blood of Bal", text: "The vampire can see through the eyes and hear through the ears of their thralls whenever they wish, and their thralls no longer suffer the Int penalty involved with their enthrallment."},
                    {name: "Dark Sight"},
                    {name: "Weakness (Fire, 4)"},
                    {name: "Immunity (Normal Weapons)"},
                    {name: "Undead"},
                    {name: "Diseased (-20, Vampiric Strain)"},
                ]},
            {head: "Spells", kind: "list", items: [
                    {name: "Frost Bite 6", text: "13 MP; 2d8 Frost; Attack, Overload (+WpB to Damage), Melee (1m)"},
                    {name: "Frost Bolt 4", text: "10 MP; 1d10 Frost; Ranged (100m), Overload (+WB to Damage), Attack"},
                    {name: "Frost Storm 4", text: "15 MP; 1d10 Frost; Ranged (100m), AoE (7m, Sphere), Upkeep, Attack"},
                    {name: "Paralyze 3", text: "25 MP; Upkeep, Direct, Attack; Target character within 50m must test Wp at +0 or be Paralyzed for 1 round."},
                    {name: "Silence 5", text: "19 MP; Upkeep, Direct, Attack; Target character within 50m must test Wp at -20 or be Silenced for 1 round."},
                ]},
            {head: "Variant: Bloodkin Master Vampire", kind: "list", items: [
                    {text: "Choose a Bloodline from the Rules Compendium. Bloodkin Master Vampires gain a passive ability from the chosen bloodline. Additionally, they gain the corresponding bloodline power and talent from the Child of the Night Elite advance and one Legendary Nox Arcana or Hemomancy ability."},
                ]},
            {head: "Encountering Master Vampires", kind: "prose", items: [
                    {text: "Charming, seductive, deadly, and domineering, Master Vampires are near the apex of their power and are amongst the deadliest foes an adventurer can face. They are almost always accompanied by a retinue of thrall and lesser vampires who serve their will without question and seldom face threats alone. When they must enter the fray, they possess powerful vampiric abilities and blood magic that can easily make short-work of their foes. Some will live secluded lives away from society, though never without some semblance of opulence, while others may live amongst Tamrielic society as rich and powerful nobles."},
            ...
            {head: "Loot", kind: "list", items: [
                    {text: "A Character can make a +0 Alchemy test to harvest a portion of \u201cMaster Vampire Dust\u201d, which is a Extremely Rare Illusion or Restoration Ingredient, chosen when the vampire dust is used."},
                ]},
        ],
    },
    "Vampire Lord": {
        name: "Vampire Lord",
        flavour: "The pinnacle of vampiric power, they have been \u201cblessed\u201d by the Prince of Domination himself and are often nigh-unstoppable. Their mastery of foul magic and dominating presence makes them extremely deadly, and their ambitions know no bounds.",
        tags: "Humanoid, Vampire, Undead, Any Race; Extreme; Black Soul (1500)",
        stats: [
            {group: "Characteristics", rows: [["Strength", "60"], ["Endurance", "70"], ["Agility", "65"], ["Intelligence", "60"], ["Willpower", "80"], ["Perception", "70"], ["Personality", "45"], ["Morale", "90"]]},
            {group: "Attributes", rows: [["Hit Points", "47"], ["Wound Thr.", "22"], ["Magicka", "60"], ["Stamina", "8"], ["Initiative", "+21"], ["Action Pts.", "4"], ["Speed", "20m"], ["Size", "Std."]]},
            {group: "Skills", rows: [["Combat", "110"], ["Magic", "100"], ["Evade", "85"], ["Observe", "90"], ["Stealth", "90"], ["Knowledge", "80"], ["Social", "65"], ["Physical", "80"]]},
        ],
        sections: [
            {head: "Vampires", kind: "prose", items: [
                    {text: "Forced to forever thirst for the blood of mortals, Vampires foul creatures born of the hateful magics of the Prince of Domination, Molag Bal. Some are no more than ravenous beasts stalking the countryside and back alleys for their next victim, while others are well hidden within the nobility of Tamriel and lead luxurious lives. Their affliction is seen as a curse by most, but some recognize it as a pathway to incredible, and terrible, power."},
            ...
            {head: "Weapons and Armor", kind: "list", items: [
                    {name: "Claws", text: "1d4+2; Slashing, Poison, Exploit Weakness, Magic; 1m Reach"},
                    {name: "Fangs", text: "1d12; Splitting, Magic, Feed; 1m Reach"},
            ...
            {head: "Special Abilities", kind: "list", items: [
                    {name: "Feed (1 AP)", text: "The vampire feeds on a restrained, helpless, or enthralled target as a standard attack with their fangs, regaining HP equal to the damage dealt after mitigation. If a point of damage is dealt successfully, the target\u2019s Endurance characteristic is reduced by 10 until after their next long rest. The vampire can choose to use this ability to Coup de Gr\u00e2ce the target as long as the conditions are met, in which case they regain the target\u2019s remaining HP. Doing so costs 2 AP and the vampire cannot take actions until their AP is refreshed."},
                    {name: "Exsanguinate (2 AP)", text: "The vampire can use their fangs to Coup de Gr\u00e2ce the target as long as the conditions are met, in which case they regain the target\u2019s remaining HP. After doing so, the vampire loses any remaining AP for the round."},
                    {name: "Master of Blood & Night", text: "The vampire lord knows all non-legendary Nox Arcana & Hemomancy abilities."},
                ]},
            {head: "Traits", kind: "list", items: [
                    {name: "Sun-Scarred (3)", text: "Any damage inflicted on a character with this trait after mitigation by an attack that counts as sunlight is increased by 3 before calculating the effects of the damage. If this character is exposed to normal sunlight they lose 1 SP each hour. Cloud cover or other such weather halves the rate of SP loss. The character must spend an hour in a dark place before they can remove levels of fatigue/regain SP lost in this manner."},
                    {name: "Dawn-Cursed (3)", text: "While in direct sunlight, the character suffers 3 damage per round which ignores all damage mitigation. If the character covers themselves completely with clothing and a hood with sufficient coverage, this damage is reduced to 3 per hour in the sunlight."},
                    ...
                    {name: "Undead"},
                    {name: "Diseased (-20, Vampiric Strain)"},
                    {name: "Venomous Claws", text: "Attacks with their claws force the target to make a +0 Endurance test, gaining the Paralyzed condition for 1 round on a failure."},
                ]},
            {head: "Spells", kind: "list", items: [
                    {name: "Frost Bite 6", text: "13 MP; 2d8 Frost; Attack, Overload (+WpB to Damage), Melee (1m)"},
                    {name: "Frost Bolt 4", text: "10 MP; 1d10 Frost; Ranged (100m), Overload (+WB to Damage), Attack"},
            ...
            {head: "Variant: Bloodkin Vampire Lord", kind: "list", items: [
                    {text: "Choose a Bloodline from the Rules Compendium. Bloodkin Vampire Lord gain a passive ability from the chosen bloodline. Additionally, they gain the corresponding bloodline power and talent from the Child of the Night Elite advance and both Legendary abilities from Nox Arcana or Hemomancy."},
                ]},
            {head: "Encountering Vampire Lords", kind: "prose", items: [
                    {text: "The true pinnacle of vampiric power, Vampire Lords are some of the deadliest individuals on the face of Nirn. They have been touched by the foul corruption of Molag Bal directly and are possessed of truly terrifying abilities that are more than a match for even the most experienced adventurers. They almost always control a small army of thralls and lesser vampires, and the pursuit of their ambitions typically have dire consequences for mortals."},
                    {text: "It is recommended that GMs use Vampire Lords as the ultimate challenge a party may face during their journeys. GMs should outfit them with powerful custom weapons, armor, and enchanted gear; the provided list of equipment are suggestions, but GMs should not feel constrained by it. It may be best to \u201cbuild-up\u201d a Vampire Lord over the course of a campaign, with the party steadily fighting tougher and tougher vampiric foes until finally facing their foul master."},
                    {text: "Even alone, the Vampire Lord is an extremely difficult foe for any party to fight. Their immunity to normal weapons means that the unprepared party is doomed, and their complete mastery over both Nox Arcana and Hemomancy means they have powerful magical abilities to call upon in addition to any other forms of magic they may know. Furthermore, simply being in the presence of a Vampire Lord can cause a debilitating panic effect. Their weakness to sunlight is the only chink Vampire Lords have in their impressive arsenal, so providing parties the means to exploit this in some way can provide for interesting encounter design."},
                ]},
            {head: "Loot", kind: "list", items: [
                    {text: "A Character can make a +0 Alchemy test to harvest a portion of \u201cVampire Lord Dust\u201d, which is a Legendary Illusion or Restoration Ingredient, chosen when the vampire dust is used."},
                    {text: "GMs should consider the treasure a Vampire Lord has in their sanctum."},
                ]},
        ],
    },
    "Werewolf": {
        name: "Werewolf",
        flavour: "As swift as they are savage, these werebeasts often hunt in packs to ambush any unfortunate mortals that cross their path in the wilderness of Tamriel.",
        tags: "Humanoid, Beast, Lycanthrope; Major; Black Soul (1500)",
        stats: [
            {group: "Characteristics", rows: [["Strength", "55"], ["Endurance", "70"], ["Agility", "50"], ["Intelligence", "30"], ["Willpower", "35"], ["Perception", "50"], ["Personality", "30"], ["Morale", "85"]]},
            {group: "Attributes", rows: [["Hit Points", "45"], ["Wound Thr.", "15"], ["Magicka", "30"], ["Stamina", "7"], ["Initiative", "+13"], ["Action Pts.", "3"], ["Speed", "15m"], ["Size", "Std."]]},
            {group: "Skills", rows: [["Combat", "95"], ["Magic", "-"], ["Evade", "60"], ["Observe", "70"], ["Stealth", "60"], ["Knowledge", "10"], ["Social", "10"], ["Physical", "95"]]},
        ],
        sections: [
            {head: "Lycanthropes", kind: "prose", items: [
                    {text: "Cursed to undergo a harrowing change of form under the influence of the moons, Lycanthropes are mortals who have been touched by the powers of The Huntsman, Hircine. They come in a variety of shapes and sizes, from swift wolves, strong boars, savage bears, to even more exotic beasts. They often live on the fringes of Tamrielic society, being almost universally despised, and their condition is considered a curse by most. Some, however, see the transformation as a gift and fully give themselves to the beast within."},
                    {text: "The profiles in this section can represent the beast form of any NPC cursed with lycanthropy. In these cases, the GM should choose a NPC profile from Chapter 3: People to represent the humanoid form of this character."},
                ]},
            {head: "Weapons and Armor", kind: "list", items: [
                    {name: "Claws", text: "1d10; Slashing; 1m Reach"},
                    {name: "Fangs", text: "1d8; Splitting; 1m Reach"},
                    {name: "Natural Toughness (4), Natural Toughness (2) in non-beast form."},
                ]},
            {head: "Special Abilities", kind: "list", items: [
                    {name: "Consume (2 AP)", text: "The werewolf consumes part of the corpse of a dead creature. They regain the consumed creature\u2019s EB."},
                    {name: "Consume Heart (3 AP)", text: "The werewolf consumes the heart of a dead creature. They regain twice the consumed creature\u2019s EB."},
            ...
            {head: "Traits", kind: "list", items: [
                    {name: "Silver-Scarred (4), Silver-Scarred (2) in non-beast form."},
                    {name: "Unnatural Senses (Smell, 6), Unnatural Senses (Smell, 3) in non-beast form"},
                    {name: "Diseased (-20, Werewolf Lycanthropy)"},
                    {name: "Immunity (Disease)"},
                    {name: "Restless", text: "The character only restores half the health, magicka, and stamina they normally would while resting."},
                    {name: "Dark Sight"},
                    {name: "Quadruped"},
                    ...
                    {name: "Bestial Leap", text: "Penalties from jumping are halved."},
                    {name: "Savage", text: "Rolls damage twice and uses the highest result."},
                ]},
            {head: "Encountering Werewolves", kind: "prose", items: [
                    {text: "By far the most common form of lycanthrope found across Tamriel, Werewolves are swift and deadly hunters who often use stealth to ambush their prey. They often form packs of their own kind, away from greater Tamrielic society, and these typically become tightly-knit clans who hunt alongside one another. This behavior makes them all the more deadly to face; a lone Werewolf is dangerous, but a pack can easily be overwhelming even for experienced hunters. Werewolves are feared across Tamriel, and many rural communities have stories of foul man-wolves killing children who wander too close to the town\u2019s edge on the night of a full moon."},
                    {text: "GMs using the base Werewolf should be aware of their strengths and weaknesses; they are stealthy and agile, but generally weaker than other forms of lycanthrope. Operating in packs, therefore, can make them much harder foes for a party to encounter. The social stigma related to lycanthropy can also lead some to try and hide their affliction, while others may fully embrace the \u201cgifts\u201d of Lord Hircine, providing interesting quest-making opportunities for the creative GM. In any case, a well-equipped party with silver weapons should be able to take on a Werewolf, or even a small pack of them. However, Werewolf-hunters should be mindful that they don\u2019t contract a lycanthropic disease themselves!"},
                ]},
            {head: "Loot", kind: "list", items: [
                    {text: "A character can make a -10 Survival test to skin the beast. Lycan hide is valued at 500 drakes. Failing the test ruins the hide, halving its value."},
                    {text: "A character can make a +0 Survival test to remove a Werewolf Claw from the beast\u2019s hand, which is an uncommon Destruction ingredient."},
                ]},
        ],
    },
    "Werewolf Vargr": {
        name: "Werewolf Vargr",
        flavour: "Older and more experienced than their packmates, they have fully given themselves to the beast within to become the ultimate ambush hunter.",
        tags: "Humanoid, Beast, Lycanthrope; Extreme; Black Soul (1500)",
        stats: [
            {group: "Characteristics", rows: [["Strength", "55"], ["Endurance", "70"], ["Agility", "50"], ["Intelligence", "30"], ["Willpower", "35"], ["Perception", "50"], ["Personality", "30"], ["Morale", "85"]]},
            {group: "Attributes", rows: [["Hit Points", "45"], ["Wound Thr.", "15"], ["Magicka", "30"], ["Stamina", "7"], ["Initiative", "+13"], ["Action Pts.", "3"], ["Speed", "20m"], ["Size", "Std."]]},
            {group: "Skills", rows: [["Combat", "105"], ["Magic", "-"], ["Evade", "70"], ["Observe", "80"], ["Stealth", "70"], ["Knowledge", "10"], ["Social", "10"], ["Physical", "105"]]},
        ],
        sections: [
            {head: "Lycanthropes", kind: "prose", items: [
                    {text: "Cursed to undergo a harrowing change of form under the influence of the moons, Lycanthropes are mortals who have been touched by the powers of The Huntsman, Hircine. They come in a variety of shapes and sizes, from swift wolves, strong boars, savage bears, to even more exotic beasts. They often live on the fringes of Tamrielic society, being almost universally despised, and their condition is considered a curse by most. Some, however, see the transformation as a gift and fully give themselves to the beast within."},
            ...
            {head: "Weapons and Armor", kind: "list", items: [
                    {name: "Claws", text: "1d10+2; Slashing, Exploit Weakness, Magic; 1m Reach"},
                    {name: "Fangs", text: "1d8+2; Splitting; 1m Reach"},
                    {name: "Natural Toughness (4), Natural Toughness (2) in non-beast form."},
                ]},
            {head: "Special Abilities", kind: "list", items: [
                    {name: "Consume (2 AP)", text: "The werewolf consumes part of the corpse of a dead creature. They regain the consumed creature\u2019s EB."},
                    {name: "Consume Heart (3 AP)", text: "The werewolf consumes the heart of a dead creature. They regain four times the consumed creature\u2019s EB."},
                    {name: "Latch On (1 SP)", text: "If the creature successfully Bites a target which results in a grapple, it latches on as a free action. As a result, the grappled character receives a -20 penalty to their attempts to break free. Alternatively, the grappled target can instead end the grapple as a free action. In doing so, they suffer the Bleeding (2) Condition and must test for Disease."},
                    {name: "Thrill of the Chase (Once per round)", text: "Uses the Dash Action to move towards an enemy without spending AP."},
                    {name: "Call of the Wolf (Once per day)", text: "As a Primary Action, the werewolf howls. All who can hear within 20m must make a +10 panic test."},
                ]},
            {head: "Traits", kind: "list", items: [
                    {name: "Silver-Scarred (4), Silver-Scarred (2) in non-beast form."},
                    {name: "Unnatural Senses (Sight, Hearing, Smell, 30), Unnatural Senses (Smell, 3) in non-beast form"},
                    {name: "Immunity (Disease)"},
                    {name: "Diseased (-20, Werewolf Lycanthropy)"},
                    {name: "Restless", text: "The character only restores half the health, magicka, and stamina they normally would while resting."},
                    {name: "Dark Sight"},
            ...
            {head: "Encountering Werewolve Vargrs", kind: "prose", items: [
                    {text: "Stronger, faster, and more deadly than the average werewolf, Werewolf Vargr\u2019s often take on the form of pack-leaders amongst their kind. They have fully given themselves to the beast within, guiding less-experienced members of their pack to more fully embrace Hircine\u2019s gifts. Werewolf Vargrs are experienced and deadly foes, representing the pinnacle of swift and agile ambush hunters amongst their kind."},
                    {text: "GMs should consider using Werewolf Vargrs as pack leaders, rather than having them be encountered on their own. While faster and stronger than the average werewolf, their true ferocity is unlocked when fighting alongside others of their kind. The creative GM may want to make a Werewolf Vargr unique, especially if they play a prominent role in a quest or campaign. A silvered mane, scars, or missing teeth can make such a creature stand out from the rest and provide a party of werewolf-hunters an ultimate prize to pursue."},
                ]},
            {head: "Loot", kind: "list", items: [
                    {text: "A character can make a -10 Survival test to skin the beast. Lycan hide is valued at 500 drakes. Failing the test ruins the hide, halving its value."},
                    {text: "A character can make a +0 Survival test to remove a Werewolf Vargr Claw from the beast\u2019s hand, which is a Very Rare Destruction ingredient."},
                ]},
        ],
    },
    "Wereboar": {
        name: "Wereboar",
        flavour: "Hardy, unpredictable, and hard to take-down, these man-boars are known to gore their victims with their sharp tusks before devouring them.",
        tags: "Humanoid, Beast, Lycanthrope; Major; Black Soul (1500)",
        stats: [
            {group: "Characteristics", rows: [["Strength", "55"], ["Endurance", "80"], ["Agility", "45"], ["Intelligence", "30"], ["Willpower", "35"], ["Perception", "45"], ["Personality", "30"], ["Morale", "85"]]},
            {group: "Attributes", rows: [["Hit Points", "50"], ["Wound Thr.", "16"], ["Magicka", "30"], ["Stamina", "8"], ["Initiative", "+11"], ["Action Pts.", "3"], ["Speed", "13m"], ["Size", "Std."]]},
            {group: "Skills", rows: [["Combat", "95"], ["Magic", "-"], ["Evade", "55"], ["Observe", "65"], ["Stealth", "45"], ["Knowledge", "10"], ["Social", "10"], ["Physical", "95"]]},
        ],
        sections: [
            {head: "Lycanthropes", kind: "prose", items: [
                    {text: "Cursed to undergo a harrowing change of form under the influence of the moons, Lycanthropes are mortals who have been touched by the powers of The Huntsman, Hircine. They come in a variety of shapes and sizes, from swift wolves, strong boars, savage bears, to even more exotic beasts. They often live on the fringes of Tamrielic society, being almost universally despised, and their condition is considered a curse by most. Some, however, see the transformation as a gift and fully give themselves to the beast within."},
            ...
            {head: "Weapons and Armor", kind: "list", items: [
                    {name: "Claws", text: "1d10; Slashing; 1m Reach"},
                    {name: "Tusks", text: "1d8; Slashing; 1m Reach"},
                    {name: "Natural Toughness (8), Natural Toughness (4) in non-beast form."},
                ]},
            {head: "Special Abilities", kind: "list", items: [
                    {name: "Consume (2 AP)", text: "The wereboar consumes part of the corpse of a dead creature. They regain the consumed creature\u2019s EB."},
                    {name: "Consume Heart (3 AP)", text: "The wereboar consumes the heart of a dead creature. They regain twice the consumed creature\u2019s EB"},
                    {name: "Gore (1 SP)", text: "As part of a successfully damaging attack with their tusks, the wereboar can spend a Stamina Point to immediately deal a bonus SB damage."},
                ]},
            {head: "Traits", kind: "list", items: [
                    {name: "Silver-Scarred (4), Silver-Scarred (2) in non-beast form."},
                    {name: "Unnatural Senses (Smell, 6), Unnatural Senses (Smell, 3) in non-beast form"},
                    {name: "Diseased (-20, Wereboar Lycanthropy)"},
                    {name: "Immunity (Disease)"},
                    {name: "Restless", text: "The character only restores half the health, magicka, and stamina they normally would while resting."},
                    {name: "Dark Sight"},
                    {name: "Quadruped"},
    ...
    "Wereboar Gore-Tusk": {
        ...
        sections: [
            ...
            {head: "Weapons and Armor", kind: "list", items: [
                    {name: "Claws", text: "1d10; Slashing, Magic; 1m Reach"},
                    {name: "Tusks", text: "1d8; Slashing, Exploit Weakness, Magic; 1m Reach"},
                    {name: "Natural Toughness (10), Natural Toughness (4) in non-beast form."},
                ]},
            {head: "Special Abilities", kind: "list", items: [
                    {name: "Consume (2 AP)", text: "The wereboar consumes part of the corpse of a dead creature. They regain the consumed creature\u2019s EB."},
                    {name: "Consume Heart (3 AP)", text: "The wereboar consumes the heart of a dead creature. They regain four times the consumed creature\u2019s EB"},
                    {name: "Gore (1 SP)", text: "As part of a successfully damaging attack with their tusks, the wereboar can spend a Stamina Point to immediately deal a bonus SB damage."},
                ]},
            {head: "Traits", kind: "list", items: [
                    {name: "Silver-Scarred (4), Silver-Scarred (2) in non-beast form."},
                    ...
                    {name: "Dark Sight"},
                    {name: "Quadruped"},
                    {name: "Strong Jaws", text: "Bite attack made by this character Bite attack made by this character that deals damage automatically starts a Grapple. The test to contest this Grapple is made against the original test made by the attacker. If the target Counter Attacks a Bite attack, the Counter Attack ignores the creature\u2019s AR and Natural Toughness trait."},
                    {name: "Bestial Leap", text: "Penalties from jumping are halved."},
                    {name: "Savage", text: "Rolls damage twice and uses the highest result."},
                    {name: "Tough(3)", text: "Increases WT by 3 in both forms. This is already included in the WT for this profile."},
                    ...
                    {name: "Aspect of Tenacity", text: "Penalties from passive wound effects are halved."},
                ]},
            {head: "Encountering Wereboar Gore-Tusks", kind: "prose", items: [
                    {text: "Stronger and more aggressive than the common Wereboar, Wereboar Gore-Tusks are worthy opponents for even the most experienced and well-equipped monster hunters. Like the common Wereboar, Gore-Tusks are powerhouses on the field pf battle and prefer to meet their foes head-on, overwhelming them with sheer strength and resistance to damage."},
                    {text: "Their rarity outside of High Rock & Hammerfell, their exceptionally high natural toughness, and the sheer strength of their traits should give any GM who wishes to use this creature at their table pause. Gore-Tusks will make short work of an ill-equipped or low-level party as they can simply shrug-off most attacks, and even those attacks that do connect are unlikely to cause a wound. As with the standard variant, only parties outfitted for a lengthy, brutal fight have a chance at taking one of these ill-tempered beasts down."},
                ]},
            {head: "Loot", kind: "list", items: [
                    {text: "A character can make a -10 Survival test to skin the beast. Lycan hide is valued at 500 drakes. Failing the test ruins the hide, halving its value."},
                    {text: "A character can make a +0 Survival test to remove a Wereboar Gore-Tusk\u2019s Tusk from the beast\u2019s maw, which is a Very Rare Restoration ingredient."},
                ]},
        ],
    },
    "Werebear": {
        ...
        tags: "Humanoid, Beast, Lycanthrope; Major; Black Soul (1500)",
        stats: [
            {group: "Characteristics", rows: [["Strength", "60"], ["Endurance", "75"], ["Agility", "45"], ["Intelligence", "30"], ["Willpower", "35"], ["Perception", "45"], ["Personality", "30"], ["Morale", "85"]]},
            {group: "Attributes", rows: [["Hit Points", "47"], ["Wound Thr.", "16"], ["Magicka", "30"], ["Stamina", "7"], ["Initiative", "+11"], ["Action Pts.", "3"], ["Speed", "14m"], ["Size", "Std."]]},
            {group: "Skills", rows: [["Combat", "100"], ["Magic", "-"], ["Evade", "55"], ["Observe", "65"], ["Stealth", "25"], ["Knowledge", "10"], ["Social", "10"], ["Physical", "100"]]},
        ],
        sections: [
            {head: "Lycanthropes", kind: "prose", items: [
                    {text: "Cursed to undergo a harrowing change of form under the influence of the moons, Lycanthropes are mortals who have been touched by the powers of The Huntsman, Hircine. They come in a variety of shapes and sizes, from swift wolves, strong boars, savage bears, to even more exotic beasts. They often live on the fringes of Tamrielic society, being almost universally despised, and their condition is considered a curse by most. Some, however, see the transformation as a gift and fully give themselves to the beast within."},
            ...
            {head: "Weapons and Armor", kind: "list", items: [
                    {name: "Claws", text: "1d12; Slashing or Crushing; 1m Reach"},
                    {name: "Fangs", text: "1d10; Splitting or Crushing; 1m Reach"},
                    {name: "Natural Toughness (6), Natural Toughness (3) in non-beast form."},
                ]},
            {head: "Special Abilities", kind: "list", items: [
                    {name: "Consume (2 AP)", text: "The werebear consumes part of the corpse of a dead creature. They regain the consumed creature\u2019s EB."},
                    {name: "Consume Heart (3 AP)", text: "The werebear consumes the heart of a dead creature. They regain twice the consumed creature\u2019s EB"},
                    {name: "Maul (1 AP + 2 SP)", text: "The werebear performs a melee attack as a Primary Action that deals 2d8 Crushing damage to a target creature within 1 meter. Additionally, all creatures within reach that are Medium or smaller must succeed on an Acrobatics or Athletics test or be knocked prone."},
                ]},
            {head: "Traits", kind: "list", items: [
                    {name: "Silver-Scarred (4), Silver-Scarred (2) in non-beast form."},
                    {name: "Immunity (Disease)"},
                    {name: "Diseased (-20, Werebear Lycanthropy)"},
                    {name: "Restless", text: "The character only restores half the health, magicka, and stamina they normally would while resting."},
                    {name: "Dark Sight"},
                    {name: "Quadruped"},
                    {name: "Strong Jaws", text: "A Bite attack made by this character that deals damage automatically starts a Grapple. The test to contest this Grapple is made against the original test made by the attacker. If the target Counter Attacks a Bite attack, the Counter Attack ignores the creature\u2019s AR and Natural Toughness trait."},
                    {name: "Bestial Leap", text: "Penalties from jumping are halved."},
                    {name: "Savage", text: "Rolls damage twice and uses the highest result."},
                    {name: "Vicious(8)", text: "The werebear treats their SB as by 8 for the purposes of resolving damage."},
                ]},
            {head: "Encountering Werebears", kind: "prose", items: [
                    {text: "Possessed of great strength and a savage temperament, Werebears stalk the northern of Tamriel. Werebears are a rare sight outside of Skyrim and the islands to it\u2019s north, and even amongst those lands these beasts are almost thought to be folklore. Some say they roam in packs, others say that canis root, a herb native to Skyrim, can be used to ward them off, and yet others still deny their existence entirely. However, experienced northern hunters know these beasts are no myth, and know that to encounter one often means certain death."},
                    {text: "Players who come across these beasts should be prepared for a hard fight. While not as tough as a Wereboar or as fast as a Werewolf, Werebears possess a thick hide and powerful natural weapons. Their natural toughness is enough to soak up many attacks, while their fangs and claws can make short work of the ill-prepared adventurer. GM\u2019s should also make note of the Vicious trait Werebears have, which can make their attacks do even more damage than would otherwise be expected."},
                    {text: "For a low-level party, Werebears can be deadly, and they can prove challenging for even well-seasoned adventurers. A GM who wants to use these beasts at their table should consider these when designing encounters that involve these creatures."},
                ]},
            {head: "Loot", kind: "list", items: [
                    {text: "A character can make a -10 Survival test to skin the beast. Lycan hide is valued at 500 drakes. Failing the test ruins the hide, halving its value."},
                    {text: "A character can make a +0 Survival test to remove a Werebear Paw from the beast, which is an Uncommon Alteration ingredient."},
                ]},
        ],
    },
    "Werebear Brute": {
        ...
        stats: [
            {group: "Characteristics", rows: [["Strength", "60"], ["Endurance", "75"], ["Agility", "45"], ["Intelligence", "30"], ["Willpower", "35"], ["Perception", "45"], ["Personality", "30"], ["Morale", "85"]]},
            {group: "Attributes", rows: [["Hit Points", "47"], ["Wound Thr.", "16"], ["Magicka", "30"], ["Stamina", "7"], ["Initiative", "+11"], ["Action Pts.", "3"], ["Speed", "14m"], ["Size", "Std."]]},
            {group: "Skills", rows: [["Combat", "110"], ["Magic", "-"], ["Evade", "65"], ["Observe", "75"], ["Stealth", "25"], ["Knowledge", "10"], ["Social", "10"], ["Physical", "110"]]},
        ],
        sections: [
            {head: "Lycanthropes", kind: "prose", items: [
                    {text: "Cursed to undergo a harrowing change of form under the influence of the moons, Lycanthropes are mortals who have been touched by the powers of The Huntsman, Hircine. They come in a variety of shapes and sizes, from swift wolves, strong boars, savage bears, to even more exotic beasts. They often live on the fringes of Tamrielic society, being almost universally despised, and their condition is considered a curse by most. Some, however, see the transformation as a gift and fully give themselves to the beast within."},
            ...
            {head: "Weapons and Armor", kind: "list", items: [
                    {name: "Claws", text: "1d12+2; Slashing or Crushing, Exploit Weakness, Magic; 1m Reach"},
                    {name: "Fangs", text: "1d10+2; Splitting or Crushing; 1m Reach"},
                    {name: "Natural Toughness (6), Natural Toughness (3) in non-beast form."},
                ]},
            {head: "Special Abilities", kind: "list", items: [
                    {name: "Consume (2 AP)", text: "The werebear consumes part of the corpse of a dead creature. They regain the consumed creature\u2019s EB."},
                    {name: "Consume Heart (3 AP)", text: "The werebear consumes the heart of a dead creature. They regain four times the consumed creature\u2019s EB"},
                    {name: "Maul (1 AP + 2 SP)", text: "The were bear performs a melee attack as a Primary Action that deals 2d8 Crushing damage to a target creature within 1 meter. Additionally, all creatures within reach that are Medium or smaller must succeed on an Acrobatics or Athletics test or be knocked prone."},
                    {name: "Aspect of Strength (1-3 SP)", text: "Before rolling melee damage, the werebear can spend SP to increase the damage by +4 for each Stamina Point spent, up to a maximum of 3 SP."},
                ]},
            {head: "Traits", kind: "list", items: [
                    {name: "Silver-Scarred (4), Silver-Scarred (2) in non-beast form."},
                    {name: "Immunity (Disease)"},
                    ...
                    {name: "Savage", text: "Rolls damage twice and uses the highest result."},
                    {name: "Vicious(8)", text: "The werebear treats their SB as by 8 for the purposes of resolving damage."},
                    {name: "Might of the Bear", text: "When the werebear makes an attack with their claws, they apply Damaged (1) to the hit location if the die result (before bonuses) is 11, or Damaged (2) if the die result is 12."},
                ]},
            {head: "Encountering Werebear Brutes", kind: "prose", items: [
                    {text: "While the more common Werebear is a deadly foe, Werebear Brutes are terrifying forces of nature who can make short work of even the most seasoned adventurers. Some of these hulking beasts stalk the frozen north of Tamriel alone, while others lead packs of their kind to terrorize remote villages. They are relentless hunters and possessed of powerful natural weapons, allowing them to tackle even the most powerful of quarry with relative ease."},
                    {text: "A GM who wishes to use the Werebear Brute at their table should first consider how well-equipped their party is. These creatures get a flat +2 to damage rolls made with their natural weapons, Maul gives them an edge against groups of adventurers, and Aspect of Strength can be used to make their already formidable attacks even deadlier. Furthermore, Might of the Bear ensures that even well-armored foes quickly find their armor failing them when fighting this beast."},
                    {text: "Like the Werewolf Vargr and Werebear Gore-Tusk, Werebear Brutes are best used as boss-type foes or as a great challenge for a roving band of experienced beast-hunters to overcome."},
                ]},
            {head: "Loot", kind: "list", items: [
                    {text: "A character can make a -10 Survival test to skin the beast. Lycan hide is valued at 500 drakes. Failing the test ruins the hide, halving its value."},
                    {text: "A character can make a +0 Survival test to remove a Werebear Brute\u2019s Paw from the beast, which is a Very Rare Alteration ingredient."},
                ]},
        ],
    },
    "Daedroth": {
